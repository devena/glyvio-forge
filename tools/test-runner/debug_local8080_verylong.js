...
(async () => {
  ...
  await page.screenshot({ path: shot('105_before_override.png') });

  console.log('=== calling override ===', new Date().toISOString());
  ...
  console.log('=== override returned ===', new Date().toISOString());

  await page.waitForTimeout(180000); // 3 min
  console.log('=== after 3 min wait ===', new Date().toISOString());
  await page.screenshot({ path: shot('106_after_3min.png') });
