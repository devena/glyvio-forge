...
(async () => {
  ...
  // "Teste de funcionamento do assistente" / Jeannie Tests row, per the last screenshot
  await page.mouse.click(250, 363);
  ...
  if (chatScreen) {
    ...
    console.log('did not open a jeannie chat view');
  }
  await page.screenshot({ path: shot('117_direct_click_result.png') });
