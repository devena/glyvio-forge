...
(async () => {
  ...
  await page.screenshot({ path: shot('53_before_manual_refetch.png') });
  ...
  if (!chatScreen) { console.log('no chat screen'); await browser.close(); return; }
  ...
  console.log('dispatch result:', JSON.stringify(r1).slice(0, 500));

  await page.waitForTimeout(3000);
  await page.screenshot({ path: shot('54_after_manual_refetch.png') });
