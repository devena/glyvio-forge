...
(async () => {
  ...
  await page.screenshot({ path: shot('93_after_reload_only.png') });

  await page.mouse.click(1291, 33);
  await page.waitForTimeout(8000);
  console.log('after chat icon click, url:', page.url());
  await page.screenshot({ path: shot('94_after_chaticon_click.png') });

  const screens1 = await page.evaluate(() => window.__GLYVIO_AI__.describeCurrentScreens());
  console.log('screens after chat icon:', JSON.stringify(screens1));
