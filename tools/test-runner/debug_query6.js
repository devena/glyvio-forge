...
(async () => {
  ...
  const result = await page.evaluate(async () => {
    ...
    return {
      one_row: await safe('SELECT * FROM chat_message ORDER BY message_timestamp DESC LIMIT 1'),
      one_row_for_dc832223: await safe("SELECT * FROM chat_message WHERE chat_session_id = ? LIMIT 3", [{value:'dc832223-2be8-4aca-9a27-71cd28e45870', dataType:'TEXT'}]),
    };
  });

  fs.writeFileSync(
    '/tmp/claude-1000/-opt-data-glyvio-services/7b3f0d55-c695-4b5f-90c8-ab63a57cb02d/scratchpad/44_schema_check2.json',
