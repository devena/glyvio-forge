...
1. Determine the temp file path: `.agents/temp/<ModalName>_design.json` (e.g., `CustomerListModal_design.json`).
...
- Save the received JSON to `.agents/temp/<ModalName>_cellDesign.json`.
