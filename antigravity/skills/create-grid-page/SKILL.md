...
---
<!-- Generated from src/skills/create-grid-page/SKILL.md by tools/generate.py. Edit the source, not this file. -->
...
export class <EntityName>GridPage extends glyvio_core.SimpleGridPage<<EntityName>GridPageState, glyvio_entity.<EntityName>> {
   ...
   * antigravity/rules/references/component_catalog_full.md §15.
   *
