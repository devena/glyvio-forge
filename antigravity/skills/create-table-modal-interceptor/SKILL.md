...
1. Determine the temp file path: `.agents/temp/<ModalName>_design.json` (e.g., `ProductTableModal_design.json`).
...
- Save the received JSON to `.agents/temp/<ModalName>_rowDesign.json`.
