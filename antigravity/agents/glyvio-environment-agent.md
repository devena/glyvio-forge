...
- **Custom Agent Creation**: If asked to create a Custom Agent, you must define it in the `manifest.json` under `custom_chat_agent`. See `skills/create-custom-agent/SKILL.md` for full instructions.
